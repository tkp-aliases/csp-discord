...
lint-py:  ## lint python with ruff
	python -m ruff check csp_discord
	python -m ruff format --check csp_discord
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix csp_discord
	python -m ruff format csp_discord
...
test:  ## run python tests
	python -m pytest -v csp_discord/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v csp_discord/tests --cov=csp_discord --cov-report term-missing --cov-report xml
